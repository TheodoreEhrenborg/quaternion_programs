...
class Quaternion:
    ...
    def __init__(self, a=0, b=0, c=0, d=0,use_list=False,l=None):
        ...
        if self.Lipschitz==True or (a+.5==int(a+.5) and b+.5==int(b+.5) and c+.5==int(c+.5) and d+.5==int(d+.5)):
            self.Hurwitz=True
        else:
            self.Hurwitz=False
...
##        to_print=str(a)+'+'+str(b)+'i+'+str(c)+'j+'+str(d)+'k'
    ...
    def __mul__(self,other):
        other=self.convert(other)
        return Quaternion(self.a*other.a-self.b*other.b-self.c*other.c-self.d*other.d,self.a*other.b+self.b*other.a+self.c*other.d-self.d*other.c,self.a*other.c+self.c*other.a+self.d*other.b-self.b*other.d,self.a*other.d+self.d*other.a+self.b*other.c-self.c*other.b)
    ...
    def __div__(self,other):
        ...
        return Quaternion(round(r.a,10),round(r.b,10),round(r.c,10),round(r.d,10))
...
def pyth_factor2(number,quadrant_1_only=False,jiggle=True):#Given a Pythagorean quintuple written as a quaternion, 
    I=i()#this function attempts to factor it into two Lipschitz quaternions, both using the same numbers.
    number=I.convert(number)
   # print number
    from math import sqrt
    factors=[]
...
#            print a
    ...
    return factors
#list of 24 permutations: [[0, 1, 2, 3], [0, 1, 3, 2], [0, 2, 1, 3], [0, 2, 3, 1], [0, 3, 1, 2], [0, 3, 2, 1], [1, 0, 2, 3], [1, 0, 3, 2], [1, 2, 0, 3], [1, 2, 3, 0], [1, 3, 0, 2], [1, 3, 2, 0], [2, 0, 1, 3], [2, 0, 3, 1], [2, 1, 0, 3], [2, 1, 3, 0], [2, 3, 0, 1], [2, 3, 1, 0], [3, 0, 1, 2], [3, 0, 2, 1], [3, 1, 0, 2], [3, 1, 2, 0], [3, 2, 0, 1], [3, 2, 1, 0]]
def pyth_factor(number,quadrant_1_only=False,jiggle=True):#Given a Pythagorean quintuple written as a quaternion, 
    I=i()#this function attempts to factor it into two Hurwitz quaternions, both using the same numbers.
    number=I.convert(number)
   # print number
    from math import sqrt
